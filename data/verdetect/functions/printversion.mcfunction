...
execute if score MinecraftVersion VersionInfo matches 21 run tellraw @s "Detected Server Version: 1.21.5 Snapshot (25w09a or 25w09b)"
execute if score MinecraftVersion VersionInfo matches 22 run tellraw @s "Detected Server Version: 1.21.5 Snapshot (25w10a)"
execute if score MinecraftVersion VersionInfo matches 23 run tellraw @s "Detected Server Version: 1.21.5 Pre-Release 1"
