...
execute if score MinecraftVersion VersionInfo matches 36 run data merge storage verdetect:info {VersionString:"1.21.6",VersionName:"Chase the Skies (1.21.7 Hotfix)",IsSnapshot:true,IsRelease:false,FullVersionString:"1.21.7-rc1"}
