...
execute if score MinecraftVersion VersionInfo matches 32 run data merge storage verdetect:info {VersionString:"Unnamed",VersionName:"Summer Drop",IsSnapshot:true,IsRelease:false,FullVersionString:"25w15a-25w16a"}
execute if score MinecraftVersion VersionInfo matches 33 run data merge storage verdetect:info {VersionString:"Unnamed",VersionName:"Summer Drop",IsSnapshot:true,IsRelease:false,FullVersionString:"25w17a"}
