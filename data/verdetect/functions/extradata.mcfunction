...
execute if score MinecraftVersion VersionInfo matches 33 run data merge storage verdetect:info {VersionString:"1.21.6",VersionName:"Summer Drop",IsSnapshot:true,IsRelease:false,FullVersionString:"25w20a"}
