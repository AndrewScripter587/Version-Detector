...
execute if score MinecraftVersion VersionInfo matches 22 run data merge storage verdetect:info {VersionString:"1.21.5",VersionName:"Spring Drop",IsSnapshot:true,IsRelease:false,FullVersionString:"25w02a"}
execute if score MinecraftVersion VersionInfo matches 23 run data merge storage verdetect:info {VersionString:"1.21.5",VersionName:"Spring Drop",IsSnapshot:true,IsRelease:false,FullVersionString:"25w03a"}
execute if score MinecraftVersion VersionInfo matches 24 run data merge storage verdetect:info {VersionString:"1.21.5",VersionName:"Spring Drop",IsSnapshot:true,IsRelease:false,FullVersionString:"25w04a"}
execute if score MinecraftVersion VersionInfo matches 25 run data merge storage verdetect:info {VersionString:"1.21.5",VersionName:"Spring Drop",IsSnapshot:true,IsRelease:false,FullVersionString:"25w05a"}
execute if score MinecraftVersion VersionInfo matches 26 run data merge storage verdetect:info {VersionString:"1.21.5",VersionName:"Spring Drop",IsSnapshot:true,IsRelease:false,FullVersionString:"25w06a"}
execute if score MinecraftVersion VersionInfo matches 27 run data merge storage verdetect:info {VersionString:"1.21.5",VersionName:"Spring Drop",IsSnapshot:true,IsRelease:false,FullVersionString:"25w07a"}
