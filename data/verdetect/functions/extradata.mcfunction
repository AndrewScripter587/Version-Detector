...
execute if score MinecraftVersion VersionInfo matches 36 run data merge storage verdetect:info {VersionString:"1.21.7",VersionName:"Chase the Skies (1.21.7 Hotfix)",IsSnapshot:true,IsRelease:false,FullVersionString:"1.21.7"}
execute if score MinecraftVersion VersionInfo matches 37 run data merge storage verdetect:info {VersionString:"TBD",VersionName:"Fall Drop",IsSnapshot:true,IsRelease:false,FullVersionString:"25w31a"}
execute if score MinecraftVersion VersionInfo matches 38 run data merge storage verdetect:info {VersionString:"TBD",VersionName:"Fall Drop",IsSnapshot:true,IsRelease:false,FullVersionString:"25w32a"}
